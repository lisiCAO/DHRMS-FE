        ...
        <Container>
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <TextField
              ...
              onBlur={formik.handleBlur}
              error={
                formik.touched.occupants && Boolean(formik.errors.occupants)
              }
            ...
            <DatePicker
              ...
              renderInput={(params) => (
                <TextField
                  {...params}
                  error={
                    formik.touched.leaseStart &&
                    Boolean(formik.errors.leaseStart)
                  }
                  helperText={
            ...
            <DatePicker
              ...
              renderInput={(params) => (
                <TextField
                  {...params}
                  error={
                    formik.touched.leaseEnd && Boolean(formik.errors.leaseEnd)
                  }
