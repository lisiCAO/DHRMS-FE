...
const LeaseCreate = () => {
  ...
  const validationSchema = Yup.object({
    ...
    monthlyRent: Yup.number().required('Monthly rent is required').positive('Monthly rent must be positive').integer('Monthly rent must be an integer'),
    deposit: Yup.number().required('Deposit is required').positive('Deposit must be positive').integer('Deposit must be an integer'),
            ...
            <Grid container spacing={3}>
              <Grid item xs={12}>
                ...
                <DatePicker
                  ...
                  renderInput={(params) => <TextField {...params} fullWidth helperText={formik.touched.startDate && formik.errors.startDate} />}
                />
                <Typography variant="body1">
                ...
                <DatePicker
                  ...
                  renderInput={(params) => <TextField {...params} fullWidth helperText={formik.touched.endDate && formik.errors.endDate} />}
                />
                <Typography variant="body1">
